...
tryCatch({
  ...
  dias_num <- as.POSIXlt(d$Date)$wday
  ...
  mes_num <- as.POSIXlt(d$Date)$mon + 1
  ...
  # Aplicar a todas as variáveis
  for (v in num_vars) {
    n_out <- count_outliers(d[[v]])
    cat(v, ":", n_out, "outliers\n")
  }
  ...
  # ============================================================
  # 10. MATRIZ DE CORRELACAO (Pearson) + HEATMAP
  # ============================================================
  
  cat("========================================\n")
  cat("10. MATRIZ DE CORRELACAO (Pearson)\n")
  cat("========================================\n")
  numeric_vars <- d[, c("Num_Employees",
                        "Num_Customers",
                        "Pct_On_Sale",
                        "Sales")]
