...
# Guardar historicos de convergencia para comparativos.R
mc_dir <- file.path(output_dir, "MC")
dir.create(mc_dir, showWarnings = FALSE)
saveRDS(profit_history,    file.path(mc_dir, "convergencia_O1_MC_nuno.rds"))
saveRDS(profit_history_O2, file.path(mc_dir, "convergencia_O2_MC_nuno.rds"))
cat("RDS de convergencia guardados em:", mc_dir, "\n")
